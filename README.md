...
| :--- | :--- |
| **AI & Agent Orchestration** | LangChain, LangGraph, CrewAI, Gemini 2.5 Pro / Flash, OpenAI, Pydantic v2, Deterministic Guardrails |
| **Data Pipelines & Storage** | Supabase, PostgreSQL, ChromaDB, Redis, High-Throughput Memory Buffers, ETL / ELT |
| **Backend & APIs** | Python 3.11+, FastAPI, Flask, Streamlit, Asynchronous Workers |
| **Infrastructure & CI/CD** | Docker, Google Cloud Run, GitHub Actions CI/CD Quality Gates, Linux VPS, Nginx |
| **Enterprise Work OS** | Monday.com API / GraphQL, n8n Orchestration, GIS & Spatial Geocoding (Nominatim) |
...
### 📐 Engineering Rigor & Principles
- **Type Safety Over Guesswork:** All payload boundaries enforce Pydantic v2 schemas.
- **Automated Quality Gates:** Every repository features automated Pytest suites running in GitHub Actions CI.
- **Defensive Data Handling:** Paginated API consumption, graceful fallbacks, and real logging over unhandled exceptions.
